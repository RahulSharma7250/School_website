...
export default function TrilokAcademics() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative">
        <div className="bg-gradient-to-r from-emerald-500 to-teal-700 h-[40vh] min-h-[300px]">
          <div
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <div className="mt-6">
                          <Button className="bg-emerald-600 hover:bg-emerald-700">Download Primary Curriculum</Button>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <div className="mt-6">
                          <Button className="bg-emerald-600 hover:bg-emerald-700">Download Secondary Curriculum</Button>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                  ...
                  <CardContent className="p-6">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                      ...
                      <div>
                        ...
                        <div className="mt-6">
                          <Button className="bg-emerald-600 hover:bg-emerald-700">
                            Download Sr. Secondary Curriculum
                          </Button>
                        </div>
                      </div>
                    </div>
      ...
      <section className="py-16">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-700">
                        ...
                        <li>School topper: Ananya Sharma (98.6%)</li>
                    ...
                    <div>
                      ...
                      <ul className="list-disc pl-5 space-y-2 text-gray-700">
                        ...
                        <li>Science stream topper: Rahul Verma (97.8%)</li>
                        <li>Commerce stream topper: Priya Patel (98.2%)</li>
                        <li>Humanities stream topper: Aditya Singh (96.4%)</li>
          ...
          <div className="mt-8 text-center">
            <Button className="bg-emerald-600 hover:bg-emerald-700">View All Academic Achievements</Button>
          </div>
        </div>
      </section>
