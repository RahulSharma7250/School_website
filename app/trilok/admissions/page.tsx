...
export default function TrilokAdmissions() {
  return (
    <div>
      ...
      <section className="relative">
        <div className="bg-gradient-to-r from-emerald-600 to-teal-800 h-[60vh] min-h-[400px]">
          ...
          <div className="relative h-full max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center">
            ...
            >
              <span className="inline-block px-4 py-1 bg-white/20 backdrop-blur-sm text-white text-sm font-medium rounded-full mb-4">Join Us</span>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">Admissions</h1>
      ...
      <section className="py-16">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Admission Steps</span>
            <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-4">Admission Process</h2>
            <div className="w-24 h-1.5 bg-emerald-600 mx-auto mb-6 rounded-full"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A step-by-step guide to joining Trilok Vidhya Vihar Senior Secondary School
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full border-none shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
                  ...
                  <CardContent className="p-6 text-center mt-2">
                    <div className="text-sm font-medium text-emerald-600 mb-2">{step.step}</div>
                    <h3 className="text-xl font-semibold text-gray-900 mb-3 group-hover:text-emerald-600 transition-colors">{step.title}</h3>
      ...
      <section className="py-16 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8 relative">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Important Dates</span>
            <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-4">Admission Schedule</h2>
            <div className="w-24 h-1.5 bg-emerald-600 mx-auto mb-6 rounded-full"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      {/* Eligibility & Documents - Enhanced */}
      <section className="py-16">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <Card className="border-none shadow-lg h-full overflow-hidden">
                <CardContent className="p-6">
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <Button className="bg-emerald-600 hover:bg-emerald-700">Download Document Checklist</Button>
                    </div>
                  </div>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Fee Details</span>
            <h2 className="text-3xl font-bold text-gray-900 mt-2 mb-4">Fee Structure</h2>
            <div className="w-24 h-1.5 bg-emerald-600 mx-auto mb-6 rounded-full"></div>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          >
            <Card className="border-none shadow-lg overflow-hidden">
              <CardContent className="p-6">
                ...
                <div className="mt-6">
                  <Button className="bg-emerald-600 hover:bg-emerald-700">Download Complete Fee Structure</Button>
                </div>
              </CardContent>
            </Card>
          </motion.div>
      ...
      <section className="py-16">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <span className="text-emerald-600 font-semibold text-sm uppercase tracking-wider">Common Queries</span>
                ...
                <Accordion type="single" collapsible className="w-full">
                  {[
                    ...
                    },
                    {
                      ...
                      answer:
                        "You can schedule a school visit by contacting our admission office at admissions@trilokvidhyavihar.edu or by calling +91-XXXXX-XXXXX during office hours (Monday to Friday, 9:00 AM to 3:00 PM).",
                    },
                  ].map((faq, index) => (
      ...
      {/* Contact for Admissions - Enhanced */}
      <section className="py-16 bg-gray-50">
        <div className="max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="space-y-6 text-gray-700">
                <p>
                  ...
                  have about joining Trilok Vidhya Vihar Senior Secondary School.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    <HelpCircle className="h-5 w-5 text-emerald-600 mr-3 mt-1" />
                    <div>
                      <h3 className="font-medium text-gray-900">Admissions Helpline</h3>
                      <p>Phone: +91-XXXXX-XXXXX</p>
                      <p>Email: admissions@trilokvidhyavihar.edu</p>
                    </div>
                  </div>
                </div>
                <div className="pt-4">
                  <Button className="bg-emerald-600 hover:bg-emerald-700">Schedule a Campus Visit</Button>
                </div>
              </div>
            </motion.div>
            <motion.div
